...
The PEP 440 development version `0.11.0.dev0` maps to Debian version
`0.11.0~dev0-1`. The tilde ensures that the development package sorts before the eventual
...
```bash
dpkg-deb --info ../snarkyctl_0.11.0~dev0-1_amd64.deb
dpkg-deb --contents ../snarkyctl_0.11.0~dev0-1_amd64.deb
